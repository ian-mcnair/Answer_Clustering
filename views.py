...
#     # Calendar Text
#     cal = st.button("Display Calendar")
#     if cal:
#         st.markdown("## **Internship Calendar Overview**")
#         st.markdown("#### **Week of October 21st**")
#         st.markdown("- Training: Orientation")
#         st.markdown("#### **Week of October 28th**")
#         st.markdown("- Kaggle Data: Chase Deposits Maps")
#         st.markdown("#### **Week of November 4th & 11th**")
#         st.markdown("- Training: Data Master")
#         st.markdown("#### **Week of November 18th**")
#         st.markdown("- Mapping with CMA Data + Geocoding Solutions")
#         st.markdown("#### **Week of November 25th**")
#         st.markdown("- Data Wrangling/Geocoding/Aggregating to County Level")
#         st.markdown("#### **Week of December 2nd**")
#         st.markdown("- Finalizing Maps")
#         st.markdown("#### **Week of December 9th**")
#         st.markdown("- Finalizing Project Presentation")

#     # Overall Goal & Problems Encountered
#     if st.button("Display Project Goal and Obstacles"):
 
#         st.markdown("## **General Project Goal**")
#         st.markdown("### **Problem:** Identify areas of potential growth for the Zelle Product")
#         st.markdown("### **Solution:** Create visualization displaying areas of low usage and high population")
#         st.markdown("### **Obstacles**")
#         st.markdown("- Ploting too much data can crash the browser")
#         st.markdown("- Geocoding via online API's has limitations")
#         st.markdown("- Aggregating by finding closest map points takes a long time")
#         st.markdown("- Frequent map updates & collaboration isn't optimal")

#         st.markdown("### **Solutions**")
#         st.markdown("- Plotly with Mapbox backend map tiles")
#         st.markdown("- Downloading county level dataset and running locally")
#         st.markdown("- Utilizing multiprocessing for aggreagation")
#         st.markdown("- Dcoument Git/Lab workflow for future use")
